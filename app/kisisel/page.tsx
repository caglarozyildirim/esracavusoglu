          ...
          <div className="max-w-[1400px] mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="font-josefin text-white mt-8 max-w-3xl"
                   style={{ fontSize: '1.65rem', lineHeight: 1.7, fontWeight: 200 }}>
                  Bağımlılıktan Biohacking'e: Yolculuğum ve Misyonumun Temeli
                </p>
                <p className="font-josefin text-white mt-4 max-w-3xl"
                   style={{ fontSize: '1.32rem', lineHeight: 1.7, fontWeight: 200 }}>
      ...
      <section className="bg-white" style={{ padding: '3.3vmax 0' }}>
        <div className="w-full px-[4vw]">
          <div className="max-w-[1400px] mx-auto">
            ...
            {/* Quote Section - Ana sayfadaki gibi */}
            <div className="bg-black text-white" style={{ marginLeft: 'calc(-50vw + 50%)', marginRight: 'calc(-50vw + 50%)', paddingLeft: 'calc(50vw - 50%)', paddingRight: 'calc(50vw - 50%)', padding: '5vmax 0' }}>
              <div className="max-w-[900px] mx-auto text-center">
                <blockquote className="font-josefin italic"
                            style={{ fontSize: 'clamp(1.65rem, 3.3vw, 2.75rem)', lineHeight: 1.4, color: 'white' }}>
                  "Ayık Kafa'nın her bölümünde sorum şu: Daha iyi bir yaşam nasıl mümkün?"
                </blockquote>
                <p className="font-josefin mt-8" style={{ fontSize: '1.1rem', letterSpacing: '0.1em', color: 'rgba(255,255,255,0.8)' }}>
                  — DR. ESRA ÇAVUŞOĞLU
                </p>
              </div>
            </div>
            ...
            <div className="mb-20 bg-gray-50 py-16" style={{ marginLeft: 'calc(-50vw + 50%)', marginRight: 'calc(-50vw + 50%)', paddingLeft: 'calc(50vw - 50%)', paddingRight: 'calc(50vw - 50%)' }}>
              <div className="max-w-[900px] mx-auto">
                ...
                <p className="font-josefin text-gray-600 mb-4"
                   style={{ fontSize: '1.1rem', lineHeight: 1.6, fontWeight: 200 }}>
                ...
                <p className="font-josefin text-black mt-8 text-center"
                   style={{ fontSize: '1.1rem', lineHeight: 1.6, fontWeight: 300 }}>
            ...
            <div className="mb-20">
              <div className="max-w-[900px] mx-auto text-center">
                <blockquote className="font-josefin text-gray-700"
                            style={{ fontSize: '1.65rem', lineHeight: 1.8, fontWeight: 200, fontStyle: 'italic' }}>
