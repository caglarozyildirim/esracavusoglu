          ...
          <div className="max-w-[900px] mx-auto">
            ...
            <div className="mt-20 pt-20 border-t border-black/10">
              <div className="text-center">
                <h3 className="font-josefin text-black mb-8"
                    style={{ fontSize: '1.65rem', fontWeight: 200 }}>
                ...
                <div className="flex justify-center space-x-12">
                  <a href="https://www.instagram.com/esracavusoglu/" 
                    ...
                    <span className="font-josefin" style={{ fontSize: '0.9625rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                      Instagram
                    </span>
                  </a>
            ...
            <div className="mt-20 pt-20 border-t border-black/10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[900px] mx-auto">
                <div className="text-center">
                  <p className="font-josefin text-gray-600 mb-4" style={{ fontSize: '1.199rem' }}>
                  ...
                  <a href="https://www.youtube.com/watch?v=example1" 
                     ...
                     style={{ fontSize: '0.9625rem', textDecoration: 'underline' }}>
                    Programı İzle
                  </a>
                </div>
                <div className="text-center">
            ...
            <div className="mt-20 pt-20 border-t border-black/10">
              <div className="max-w-3xl mx-auto text-center">
                <h2 className="font-josefin text-black mb-8" 
                    style={{ fontSize: '2.75rem', fontWeight: 200, letterSpacing: '-0.02em' }}>
