          ...
          <div className="max-w-[900px] mx-auto">
            ...
            <form className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="font-playfair text-black block mb-2"
                         style={{ fontSize: '0.875rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                    Ad *
                  </label>
                  <input type="text" 
                         required
                         className="w-full font-playfair border-b border-black/20 pb-2 focus:border-black transition-colors outline-none"
                         style={{ fontSize: '1rem' }}
                         placeholder="Adınız" />
                </div>
                <div>
              ...
              {/* Connection Purpose */}
              <div>
                <label className="font-playfair text-black block mb-4"
                       style={{ fontSize: '0.875rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                  Bağlantı Amacınız *
                </label>
                <div className="space-y-3">
                  <label className="flex items-center">
                    ...
                    <span className="font-playfair text-gray-700" style={{ fontSize: '0.95rem' }}>
              ...
              <div>
                ...
                <textarea required
                          rows={6}
                          className="w-full font-playfair border border-black/20 p-4 focus:border-black transition-colors outline-none resize-none"
                          style={{ fontSize: '1rem' }}
              ...
              <div>
                ...
                <p className="font-playfair text-gray-500 mt-2" style={{ fontSize: '0.75rem' }}>
            ...
            <div className="mt-20 pt-20 border-t border-black/10">
              <div className="text-center">
                <h3 className="font-playfair text-black mb-8"
                ...
                <div className="flex justify-center space-x-12">
                  <a href="https://www.instagram.com/esracavusoglu/" 
                    ...
                    <span className="font-playfair" style={{ fontSize: '0.875rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                      Instagram
                    </span>
                  </a>
